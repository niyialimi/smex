...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>SMEX Change Password</title>
...
<div class="col-md-10 col-md-offset-2 col-xs-10">
    <div class="panel panel-info">
      <div class="panel-heading"><i class="fa fa-key"></i>    Admin Change Password</div>
      <div class="panel-body">
 <form action="passchangescript.php" class="form-horizontal" method="post" id="login-form" enctype="multipart/form-data" name="f1" data-toggle="validator">
  <div class="form-group">
    <label for="adminid" class="col-sm-4 control-label">Old Password</label>
    <div class="col-sm-8">
      <input type="password" class="form-control" id="oldpwd" name="oldpwd" placeholder="Your Old Password" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="password" class="col-sm-4 control-label">Confirm New Password</label>
    <div class="col-sm-8">
      <input type="password" class="form-control" id="cpwd" name="cpwd" placeholder="Retype New Password" required>
    </div>    
  </div>
  <div id="message"></div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" id="changepwd" class="btn btn-success">Change Password</button>
    </div>
  </div>
</form>
      </div>
