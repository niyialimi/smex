          ...
          <ul class="nav nav-sidebar">
             <li><a href="examadmin.php"><span style="padding-right:5px;" class="glyphicon glyphicon-dashboard"></span>Dashboard</a></li>
                ...
                <li><a href="createcat.php"><span style="padding-right:5px;" class="glyphicon glyphicon-pencil"></span>Add Exam Category</a></li>
                 ...
                 <li><a href="printresult.php"><span style="padding-right:5px;" class="glyphicon glyphicon-print"></span>Print Candidate Result</a></li>
                 <li><a href="printall.php"><span style="padding-right:5px;" class="glyphicon glyphicon-print"></span>Print All Result</a></li>
                 <li><a href="logout.php"><span style="padding-right:5px;" class="glyphicon glyphicon-off"></span>Logout</a></li>
          </ul>
         
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">All Results</h1>
...
<div id="table">
<form action="exportresult.php" method="post" enctype="multipart/form-data">
<button id="printthis" name="printthis" class="btn btn-info pull-left">Print Score Sheet</button>
<button type="submit" id="export" name="export" class="btn btn-info pull-right">Export</button>
<div id="printarea"> 
<div align="center"><img src="../image/atanda.png" width="204" height="88"><p>&nbsp;</p><?php echo '<strong>Atanda CBT Center</strong><br>'.'<strong>Oluyole Ibadan, Nigeria</strong><br>'.'';?></div><hr><h4 align="center">Candidate Score Summary</h4> <p>&nbsp;</p> 
...
<tbody>
  <tr>
   <?php
   $sn=1;
   $newquery="select register.*,scoretab.* from register inner join scoretab on register.examcode=scoretab.exam_code order by regid desc";
  ...
  ?>
   	<td><?php echo $sn; ?></td>
    <td><?php echo ucfirst($rows['lastname'])." ".ucfirst($rows['firstname']); ?></td>
    ...
    <td><?php echo round($rows['exam_score']); ?></td>
...
<!--button id="printthis" name="printthis" class="btn btn-info">Print Score Sheet</button-->
</form>
</div>
</div>
</div>
