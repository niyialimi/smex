...
<div id="logincontainer">
  ...
  <table width="70%"  border="0" align="center">
    <tr>
      ...
      <td width="71%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="form-control" type="text" name="desiredexam" id="desiredexam" data-error="Field can't be empty" value="<?php echo $_SESSION['desiredexam']; ?>" readonly>
      </td>
    </tr>
